...
export const TERMS_SECTIONS: TermsSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      // DRAFT — pending counsel review. Narrowed (2026-06) to reconcile with the
      // published Privacy promise (improvement/personalisation/marketing only with
      // consent; no sale of personal data; users are not "data sources"). See
      // POLICY_CONSTRAINTS.md §3.
      { type: "p", text: "By uploading or submitting User Content to GRID, you grant GRID a worldwide, non-exclusive, royalty-free, sublicensable, transferable license to host, store, back up, reproduce, display, transmit, adapt, format, index, cache, and distribute such User Content as reasonably necessary to operate, secure, support, and provide the Platform to you and to the Users with whom you choose to share it." },
      { type: "p", text: "Any use of your data or User Content to analyze, improve, personalize, train models on, or market the Platform is governed by our Privacy Policy and is carried out only on a lawful basis (including your consent where required). We do not sell your personal data." },
