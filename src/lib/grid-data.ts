...
export const NEWS: NewsArticle[] = [
  ...
  {
    id: "urgent-jobs",
    title: "New: urgent last-minute job posts",
    when: "1 week ago",
    category: "Marketplace",
    excerpt: "Need a creative today? Urgent posts surface to nearby available talent in minutes via Radar.",
    body: [
  ...
  {
    id: "long-term-hiring",
    title: "Long-term freelance hiring is live",
    when: "2 weeks ago",
    category: "Product",
