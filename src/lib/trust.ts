...
export const TRUST_DOCS: TrustDoc[] = [
  ...
  { path: "legal/copyright", title: "Copyright & Takedown (DMCA) Policy", category: "legal", version: V, updated: TRUST_UPDATED, status: "in-review", summary: "How to report infringing content and how counter-notices work. Creators keep their IP; clients receive the rights agreed in the contract." },
