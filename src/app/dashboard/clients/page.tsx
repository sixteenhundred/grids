...
import { ClientContactSheet } from "@/components/dashboard/client-contact-sheet";
import {
  CLIENT_TIERS,
  ENTERPRISE_SHOWCASE,
  CLIENT_BG,
...
export default function ClientSubscriptionPage() {
  ...
  const contact = (tier: "Agency" | "Enterprise") =>
    open(<ClientContactSheet tier={tier} />);

  const onCardContact = (tier: ClientTier) =>
    contact(tier.id === "enterprise" ? "Enterprise" : "Agency");
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-20 pb-6">
        ...
        {/* PRICING CARDS                                                     */}
        {/* ---------------------------------------------------------------- */}
        <section id="plans" className="rise scroll-mt-24">
          <div className="mb-7">
          ...
          <p className="mt-5 text-center text-xs text-white/40">
            Agency billed monthly. Enterprise is tailored to your organization. Plan changes here are a
        ...
        {/* COMPARISON                                                        */}
        {/* ---------------------------------------------------------------- */}
        <section id="compare" className="rise scroll-mt-24">
          <div className="mb-7">
        ...
        <section className="rise">
          ...
          <div className="mt-7">
            <Button tone="blue" arrow onClick={() => contact("Enterprise")}>
              Talk to Enterprise
            </Button>
          </div>
        </section>
        ...
        <section className="rise mx-auto max-w-3xl text-center">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-2.5">
            {["Less chaos", "Less searching", "Less friction", "More visibility", "More structure", "More execution"].map(
              (t) => (
                <span key={t} className="rounded-full border border-white/10 bg-white/[0.04] px-3.5 py-1.5 text-xs text-white/70">
                  {t}
                </span>
              ),
            )}
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/[0.025] p-1.5">
            <div className="relative overflow-hidden rounded-[calc(2.5rem-0.375rem)] bg-[radial-gradient(130%_160%_at_50%_-20%,#0c2f4f_0%,#08130f_55%,#050708_100%)] px-6 py-16 text-center shadow-[inset_0_1px_1px_rgba(255,255,255,0.08)] sm:px-12 md:py-20">
              ...
              <div className="relative mt-9 flex flex-wrap items-center justify-center gap-3">
                <Button tone="white" arrow href="/dashboard">
                  Start Free
                </Button>
                <Button variant="ghost" onClick={() => contact("Enterprise")}>
